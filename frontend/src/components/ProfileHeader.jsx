      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div className="avatar online">
            <button className="size-14 rounded-full overflow-hidden relative group disabled:opacity-50 disabled:cursor-not-allowed"
            ...
            >
              ...
              <div className={`absolute inset-0 flex items-center justify-center transition-opacity ${
                isUpdatingProfile ? 'bg-black/50 opacity-100' : 'bg-black/50 opacity-0 group-hover:opacity-100'
              }`}>
                {isUpdatingProfile ? (
